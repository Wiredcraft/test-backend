...
const definitions = {
    ...
    responseObject200: new SwaggerObjectNode('操作对象-请求成功', {
        code: new SwaggerObjectNodeSchemaAttribute('number', '状态码：0 成功，1 失败', true, 0),
        message: new SwaggerObjectNodeSchemaAttribute('string', '状态|失败原因', true, 'success'),
        data: new SwaggerObjectNodeSchemaAttribute('object', '对象实体', false, '{id: xxx, ...}'),

    }),
    responseObject: new SwaggerObjectNode('响应体', {
        ['200']: new SwaggerObjectNodeRef('#/definitions/操作对象-请求成功'),
    ...
    //     id: new SwaggerObjectNodeSchemaAttribute('integer', '数据 id', true, 1),
    // }),
    requestViewBodyNode: new SwaggerRequestBodyNode('id', 'path', null, true, '在path中指定id', 'integer'),
